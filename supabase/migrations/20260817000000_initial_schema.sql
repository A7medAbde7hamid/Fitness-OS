-- ==========================================================
-- AI FITNESS OS - SUPABASE POSTGRESQL INITIAL SCHEMA
-- File: supabase/migrations/20260817000000_initial_schema.sql
-- Bilingual AI Fitness & Wellness OS (English & Arabic RTL)
...
CREATE TABLE IF NOT EXISTS public.goals (
  ...
  metric_type VARCHAR(50) NOT NULL, -- 'kg', 'lbs', 'reps', 'minutes', 'streak_days', 'calories'
...
-- ==========================================================
-- 3. USER_PREFERENCES TABLE (AI Style, Notification, Macros)
-- ==========================================================
...
-- ==========================================================
-- 7. WORKOUTS & WORKOUT_EXERCISES TABLES
-- ==========================================================
...
-- Strict Isolation: Authenticated users can only read & write own rows
-- ==========================================================
...
-- Food Items RLS (linked through meal ownership)
